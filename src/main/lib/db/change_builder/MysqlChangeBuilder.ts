...
import { CreateIndexSpec, Dialect, DropIndexSpec, SchemaItem, SchemaItemChange } from "../dialects/models";
import _ from 'lodash'
import { ExtendedTableColumn } from "../models";
import log from 'electron-log';

const mysqlChangeLog = log.scope('database:mysql:changebuilder');
const logger = () => mysqlChangeLog;
